...
const SiteFooter = () => {
  return (
    <footer id="footer" className="border-t border-primary/10 py-10 bg-temple-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
        ...
        {/* Contact Numbers */}
        <div id="contact" className="flex flex-col items-center gap-4 mb-8">
          ...
          <div id="parking" className="flex items-center gap-2 text-primary/60 font-body text-xs md:text-sm uppercase tracking-widest font-bold px-4 py-1.5 rounded-full border border-primary/10">
            <span>🚗</span> Ample Parking Available at Venue
          </div>
        </div>
