...
const CountdownTimer = () => {
  ...
  return (
    <section className="py-10 bg-temple-gradient relative overflow-hidden">
      {/* Background Layers */}
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          <p className="font-body text-primary text-xl uppercase tracking-widest mb-6 lowercase">
            ✦ Initializing Spiritual Count ✦
          </p>
          <h2 className="font-heading text-4xl md:text-6xl font-bold text-gradient-gold mb-16">
